 ...
 * 
 * this plugin restore the stat feature as implemented in version <= 0.9.8
 * usage : just load the js file together with your project files, no registration is required
 * 
 * note : this has been superseed by the usage of the `me.save` class
 */
